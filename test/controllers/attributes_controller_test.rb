...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { attribute_set_id: @attribute.attribute_set_id, id: @attribute.id, integer: @attribute.integer, name: @attribute.name, string: @attribute.string, type_value: @attribute.type_value }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { attribute_set_id: @attribute.attribute_set_id, id: @attribute.id, integer: @attribute.integer, name: @attribute.name, string: @attribute.string, type_value: @attribute.type_value }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
